...
#a
plt.scatter(X_train[:, 0], X_train[:, 1], c=y_train, cmap="coolwarm", label="Trening skup")
plt.scatter(X_test[:, 0], X_test[:, 1], c=y_test, cmap="coolwarm", marker='x', label="Testni skup")
plt.xlabel("x1")
plt.ylabel("x2")
plt.legend()
plt.title("Vizualizacija trening i testnog skupa")
plt.show()
