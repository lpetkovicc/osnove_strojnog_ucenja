...
# Zadatak pod g)
#Ako povećamo broj ulaznih promenljivih - model dobija više informacija, što može poboljšati predikcije. Samim time metrike greške (MAE, MSE, RMSE, MAPE) obično opadaju (manja greška).
